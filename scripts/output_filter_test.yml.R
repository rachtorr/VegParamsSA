...
basin:
  ids: 1
variables: patch.total_water_in, 
patch.streamflow,
hill.gw.Qout, 
patch.transpiration_sat_zone, 
patch.transpiration_unsat_zone, 
patch.evaporation, 
...
patch.unsat_storage, 
patch.rz_storage, 
patch.detention_store, 
patch.litter.rain_stored, 
patch.water_balance
stratum.rain_stored, 
stratum.snow_stored, 
hill.gw.storage, 
...
stratum.epv.height, 
patch.streamflow_NO3, 
patch.streamflow_DON, 
hill.gw.NO3out, 
hill.gw.DONout, 
...
stratum.cs.totalc, 
patch.ndf.denitrif, 
patch.ndf.sminn_to_nitrate, 
stratum.cdf.total_mr, 
stratum.cdf.total_gr, 
stratum.cdf.psn_to_cpool 