...
input_rhessys$end_date <- "2025 10 2 2"
...
input_def_list <- list(
  ...
  list(input_hdr_list$soil_def[1], "psi_air_entry", c(0.1710, 3, n)),
  list(input_hdr_list$stratum_def[1], "epc.leaf_cn", c(30.15, 63.3, n)),
  list(input_hdr_list$stratum_def[1], "epc.branch_turnover", c(0.0109, 0.04, n)),
  list(input_hdr_list$stratum_def[1], "epc.gl_smax", c(0.0025, 0.0039, n)),
  list(input_hdr_list$stratum_def[1], "epc.flnr_age_mult", c(1.02, 1.99975, n)),
  list(input_hdr_list$stratum_def[1], "epc.litter_moist_coef", c(6.711e-05, 0.00069985, n)),
  list(input_hdr_list$stratum_def[1], "epc.psi_close", c(-9, -3.1, n)),
  list(input_hdr_list$stratum_def[1], "mrc.q10", c(1.8, 2.2, n)),
  list(input_hdr_list$stratum_def[1], "epc.vpd_close", c(2700, 5993.125, n)),
  list(input_hdr_list$stratum_def[1], "epc.leaf_turnover", c(0.12, 0.2759, n)),
  list(input_hdr_list$stratum_def[1], "epc.froot_turnover", c(0.2219, 0.7, n)),
  list(input_hdr_list$stratum_def[1], "epc.storage_transfer_prop", c(0.48, 0.575, n)),
  list(input_hdr_list$stratum_def[1], "epc.height_to_stem_coef", c(0.1840, 0.93, n)),
  list(input_hdr_list$stratum_def[1], "epc.waring_pa", c(0.12, 0.785, n)),
  list(input_hdr_list$stratum_def[1], "epc.root_growth_direction", c(0.6154, 1.445, n)),
  list(input_hdr_list$stratum_def[1], "epc.root_distrib_parm", c(6, 20, n)),
  list(input_hdr_list$stratum_def[1], "epc.proj_sla", c(6, 15, n)),
  ...
  list(input_hdr_list$stratum_def[1], "epc.flnr_sunlit", c(0.1, 0.6037, n)),
  list(input_hdr_list$stratum_def[1], "epc.flnr_shade", c(0.1008, 0.397329453125, n)),
  ...
  list(input_hdr_list$stratum_def[1], "epc.cpool_mort_fract", c(0.004, 0.05, n)),
  ...
  list(input_hdr_list$stratum_def[1], "epc.waring_pb", c(0.05, 0.92, n)),
  ...
  list(input_hdr_list$stratum_def[1], "epc.resprout_leaf_carbon", c(0.0052, 0.01, n)),
  list(input_hdr_list$stratum_def[1], "epc.alloc_frootc_leafc", c(0.3296, 1.2, n)),
...
output_variables[6,] <- data.frame("cdg", "dead_leafc", stringsAsFactors = FALSE)
output_variables[7,] <- data.frame("cdg", "leafc_store", stringsAsFactors=FALSE)
output_variables[8,] <- data.frame("cdg", "live_stemc", stringsAsFactors=FALSE)
output_variables[9,] <- data.frame("cdg", "live_crootc", stringsAsFactors=FALSE)
output_variables[10,] <- data.frame("cdg", "dead_stemc", stringsAsFactors = FALSE)
output_variables[11,] <- data.frame("cdg", "dead_crootc", stringsAsFactors=FALSE)
