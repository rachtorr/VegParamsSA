...
input_def_list <- list(
  ...
  list(input_hdr_list$stratum_def[1], "epc.leaf_cn", c(30.15, 50, n)),
  ...
  list(input_hdr_list$stratum_def[1], "epc.leaf_turnover", c(0.1200, 0.2345, n)),
  list(input_hdr_list$stratum_def[1], "epc.froot_turnover", c(0.3, 0.6, n)),
  ...
  list(input_hdr_list$stratum_def[1], "epc.waring_pa", c(0.1168, 0.63, n)),
  list(input_hdr_list$stratum_def[1], "epc.root_growth_direction", c(0.5066, 1.48, n)),
  list(input_hdr_list$stratum_def[1], "epc.root_distrib_parm", c(5, 20, n)),
  list(input_hdr_list$stratum_def[1], "epc.proj_sla", c(7, 12.5, n)),
  ...
  list(input_hdr_list$stratum_def[1], "epc.netpabs_sunlit", c(0.1, 0.373, n)),
...
output_variables[12,] <- data.frame("bd", "trans", stringsAsFactors=FALSE)
output_variables[13,] <- data.frame("cdg", "cpool", stringsAsFactors=FALSE)
output_variables[14,] <- data.frame("cdg", "psn_to_cpool", stringsAsFactors=FALSE)
...
if(nrow(option_sets_def_par[[1]])==nrow(option_sets_all)){
  ...
  write.csv(option_sets_all, paste("../out/RHESSysIOinR_output/allsim/option_sets", input_rhessys$output_filename, sep="_"), row.names = FALSE, quote=FALSE)
