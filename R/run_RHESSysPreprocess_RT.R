...
setwd("~/Google Drive File Stream/My Drive/patches/worldfiles")

# for setting up the oak grove
world <- raster("../oak_world.tif")
class <- raster("../MC_and_RS/hill269_classes.tif")

# for the entire hillslope
world <- raster("../MC_and_RS/world_hill.tif")
class2 <- class
class2[world==269] <- 1
class2[class==81] <- 81
class2[class==34] <- 34
writeRaster(class2, "../MC_and_RS/class_hill.tif")
...
template = "../templates/template_hill.txt"
